...
public class Dangerouscombinations
{
    ...
    private static Dictionary<string, string> DangerousCombinations { get; } = new()
    {
    ...
    {
        return DangerousCombinations.ContainsKey(drugA + "+" + drugB) ||
               DangerousCombinations.ContainsKey(drugB + "+" + drugA);
    }
